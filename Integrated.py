...
def run_cnc_ai_agent(llm):
    ...
    uploaded_file = st.file_uploader("Upload Excel file", type=["xlsx", "xls"], key="cnc_uploader")
...
# --- NEW CNC AGENT ---
elif step == "22. CNC AI Agent":
    st.subheader("🛠️ Litmus EDGE Agent: CNC Machine Diagnostics")
    st.markdown("This agent looks at your CNC Machine data captured from Litmus EDGE and predicts failure.")
    if llm:
